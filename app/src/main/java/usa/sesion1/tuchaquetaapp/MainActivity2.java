...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawable1 = res1.getDrawable(R.drawable.p2, getTheme());
        ...
        drawable2 = res2.getDrawable(R.drawable.p3, getTheme());
        ...
        drawable3 = res3.getDrawable(R.drawable.tucan1, getTheme());
